...
<section class="telefonia-hero nt-hero-wrapper" id="hero" aria-labelledby="hero-title" style="position: relative; min-height: 400px; display: flex; align-items: center; justify-content: center; padding: 120px 1rem 60px;">
  ...
  <div class="telefonia-hero-inner" style="position: relative; z-index: 3; max-width: 900px; text-align: center; color: white; text-shadow: 2px 2px 4px rgba(0,0,0,0.7);">
    <div id="hero-title" style="margin-bottom: 1rem;">
      <?= nt_heading('¿Tu teléfono empresarial te limita?', 'fa-solid fa-phone-slash', 'lg', 'Es hora de evolucionar', ['animate' => true, 'delay' => 'sm','class'=>'nt-heading-hero nt-heading-invert']); ?>
    </div>
    <p class="telefonia-hero-sub" style="color: white; font-size: 1.1rem; line-height: 1.5; margin: 0 auto 1.5rem; max-width: 700px; text-shadow: 1px 1px 3px rgba(0,0,0,0.6);">
    ...
    <div class="telefonia-hero-actions nt-stack-tight" style="display: flex; flex-wrap: wrap; justify-content: center; gap: 0.75rem;">
  ...
  <div class="max-w-7xl mx-auto px-6">
      ...
      <div class="grid md:grid-cols-3 gap-4 items-center">
        ...
        <div class="timeline-era timeline-era--past">
          <div class="timeline-era__icon">
            <i class="fa-solid fa-phone-flip text-3xl text-gray-400"></i>
          </div>
        ...
        <div class="comparison-side comparison-side--old">
          <div class="comparison-side__header">
            <div class="comparison-side__icon-wrapper">
              <i class="fa-solid fa-phone-flip text-3xl text-red-500"></i>
            </div>
          ...
          <div class="comparison-benefits">
            ...
            <div class="space-y-4">
              <div class="benefit-item">
                <i class="fa-solid fa-globe text-green-500 text-lg"></i>
                <div>
              ...
              <div class="benefit-item">
                <i class="fa-solid fa-clock text-green-500 text-lg"></i>
                <div>
              ...
              <div class="benefit-item">
                <i class="fa-solid fa-magic-wand-sparkles text-green-500 text-lg"></i>
                <div>
              ...
              <div class="benefit-item">
                <i class="fa-solid fa-star text-green-500 text-lg"></i>
                <div>
    ...
    <div class="analogy-explanation">
      <div class="grid lg:grid-cols-3 gap-4 items-center">
        ...
        <div class="analogy-step">
          <div class="analogy-step__icon">
            <i class="fa-solid fa-at text-3xl text-blue-500"></i>
          </div>
