...
<section class="nt-section pb-16 bg-white nt-hero-wrapper" style="padding-top:150px;">
    <div class="max-w-6xl mx-auto px-6 lg:px-10">
        <div class="text-center mb-12">
            <?= nt_heading('Control de Acceso Inteligente', 'fa-solid fa-door-open', 'xl', null, ['id' => 'control-acceso-hero','animate'=>true,'delay'=>'sm']); ?>
        ...
        <div class="grid md:grid-cols-2 gap-14 items-center">
            <div class="order-2 md:order-1">
                <?= nt_heading('Ventajas de nuestro sistema', 'fa-solid fa-shield-halved', 'md', null, ['animate'=>true]); ?>
